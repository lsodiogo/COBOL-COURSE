      ...
      *    DE ALUNOS: REGISTANDO, CONSULTANDO, ALTERANDO E APAGANDO
      ******************************************************************
      ...
      ******************************************************************
       ...
       01  CONS-ALUNO               PIC 9(003).
           88  INVALID-CONS-ALUNO   VALUE 000.
      ...
      *    SCREEN DO MENU PRINCIPAL.
       ...
       01  MENU1-SCREEN FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           ...
           03  LINE 05 COL 50 VALUE "G E S T O R   D E   A L U N O S".
      ...
      *    PROGRAMA.
      ...
      -        "que preencher todos os campos.".
           03  LINE 20 COL 10 VALUE "Ao preencher o numero de aluno pode
      -        " escolher a opcao para introduzir".
           03  LINE 21 COL 10 VALUE "de forma automatica ou manual".
           03  LINE 23 COL 10 VALUE "Se eventualmente surgir uma mensage
      -        "m com ''numero existente'', aconselhamos a voltar".
      ...
      *    SCREEN DO MENU REGISTAR E RESPETIVOS ACCEPT DAS VARIÁVEIS.
      ...
      -        "             DO ALUNO:".
           ...
           03  IDNUM-SCREEN FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
               05  LINE 09 COL 10 VALUE "NUMERO:".
               05  REG-IDNUM LINE 09 COL 18 PIC 9(3) TO IDNUM
               REQUIRED AUTO.
      ...
      -        "RE @ E PELO MENOS UM PONTO FINAL NO DOMINIO DE E-MAIL"
           ...
           03  ESTADO-SCREEN FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
               05  LINE 21 COL 10 VALUE "INDIQUE QUAL O ESTADO ATUAL DO
      -            "PROCESSO DO ALUNO?".
               05  REG-ESTADO LINE 21 COL 60 PIC 9(1) TO ESTADO AUTO
                   BLANK WHEN ZERO.
               05  LINE 27 COL 01 PIC X(133) VALUE ALL "_".
               05  LINE 29 COL 23 VALUE "1. INSCRITO | 2. PRESENTE | 3.
      -            "SUSPENSO | 4. CESSADO | 5. CONCLUIDO | 6. DOENTE | 7
      -            ". OUTRO".
               05  LINE 30 COL 01 PIC X(133) VALUE ALL "_".
      ...
      *    UM NÚMERO DE ALUNO QUE JÁ EXISTA.

       01  NUMERO-EXISTENTE FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           03  LINE 27 COL 01 PIC X(133) VALUE ALL "_".
           03  LINE 29 COL 30 VALUE "NUMERO EXISTENTE. INTRODUZA OUTRO |
      ...
      *    NA GRAVAÇÃO, SE PRETENDE TENTAR INSERIR UM OUTRO NÚMERO.

       01  REGISTO-NOVO-NUMERO FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           03  LINE 27 COL 01 PIC X(133) VALUE ALL "_".
           03  LINE 29 COL 33 VALUE "PRETENDE TENTAR INTRODUZIR UM NUMER
      -        "O DIFERENTE? 1 - SIM | 2 - NAO:".
      ...
      ******************************************************************
      *    SCREEN DE MENSAGEM PARA O UTILIZADOR ESCOLHER SE PRETENDE
      *    INTRODUZIR O NÚMERO DE FORMA MANUAL OU AUTOMÁTICA.

       01  FORMA-REGISTO-NUMERO FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           03  LINE 27 COL 01 PIC X(133) VALUE ALL "_".
           03  LINE 29 COL 31 VALUE "DE QUE FORMA PRETENDE REGISTAR O NU
      -        "MERO? 1 - AUTOMATICA | 2 - MANUAL:".
           03  IDNUM-ESCOLHA-SCREEN LINE 29 COL 101 PIC 9(1) TO
               NOVA-ESCOLHA AUTO BLANK WHEN ZERO.
           03  LINE 30 COL 01 PIC X(133) VALUE ALL "_".
      ...
      *    SCREEN DO MENU CONSULTAR.
       ...
       01  CONSULTAR-SCREEN FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           ...
           03  LINE 31 COL 111 VALUE "PRESSIONE F3 PARA SAIR" HIGHLIGHT
               FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           03  LINE 06 COL 10 VALUE "INDIQUE O NUMERO DO PROCESSO DO ALU
      -        "NO QUE PRETENDE CONSULTAR OS DADOS:".
      ...
      *    SCREEN DOS DADOS DO REGISTO DO FICHEIRO.
       ...
       01  CONS-DADOS-SCREEN FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           03  C-ALUNO.
               05  C-IDNUM         LINE 09 COL 18 PIC 9(3).
           ...
           03  LINE 09 COL 10 VALUE "NUMERO:".
      ...
      *    REGISTADO COMO ESTÁ NO PROCESSO.
       ...
       01  ESTADO-DISPLAY FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           03  INSCRITO-DISPLAY  LINE 21 COL 47 VALUE "INSCRITO".
           03  PRESENTE-DISPLAY  LINE 21 COL 47 VALUE "PRESENTE".
           03  SUSPENSO-DISPLAY  LINE 21 COL 47 VALUE "SUSPENSO".
           03  CESSADO-DISPLAY   LINE 21 COL 47 VALUE "CESSADO".
           03  CONCLUIDO-DISPLAY LINE 21 COL 47 VALUE "CONCLUIDO".
           03  DOENTE-DISPLAY    LINE 21 COL 47 VALUE "DOENTE".
           03  OUTRO-DISPLAY     LINE 21 COL 47 VALUE "OUTRO".
      ...
      *    UM NÚMERO QUE NÃO EXISTE.
       ...
       01  REGISTO-INEXISTENTE FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           03  LINE 27 COL 01 PIC X(133) VALUE ALL "_".
           03  LINE 29 COL 38 VALUE "NUMERO INEXISTENTE | PRESSIONE QUAL
      ...
      *    SCREEN DO MENU ELIMINAR.
       ...
       01  ELIMINAR-SCREEN FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           ...
           03  LINE 31 COL 111 VALUE "PRESSIONE F3 PARA SAIR" HIGHLIGHT
               FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           03  LINE 06 COL 10 VALUE "INDIQUE O NUMERO DO PROCESSO DO ALU
      -        "NO QUE PRETENDER ELIMINAR OS DADOS:".
           03  LINE 07 COL 01 PIC X(133) VALUE ALL "_".
      ...
      *    MESMO ELIMINAR O PROCESSO.
      ...
      -        " O PROCESSO DO ALUNO? 1 - SIM | 2 - NAO:".
           03  NOVA-ESCOLHA-SCREEN2 LINE 29 COL 104 PIC 9(1) TO
               NOVA-ESCOLHA AUTO BLANK WHEN ZERO.
           03  LINE 30 COL 01 PIC X(133) VALUE ALL "_".
      ...
      *    SCREEN DO MENU ALTERAR.
       ...
       01  ALTERAR-SCREEN FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           ...
           03  LINE 31 COL 111 VALUE "PRESSIONE F3 PARA SAIR" HIGHLIGHT
               FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           03  LINE 06 COL 10 VALUE "INDIQUE O NUMERO DO PROCESSO DO ALU
      -        "NO QUE PRETENDE MODIFICAR OS DADOS:".
           03  LINE 07 COL 01 PIC X(133) VALUE ALL "_".
      ...
      *    SCREEN DE MENSAGEM ONDE QUESTIONA QUE CAMPO PRETENDE ALTERAR.
      ...
      -       "R:".
           ...
           03  LINE 29 COL 15 VALUE "1. NOME  |  2. TELEFONE  |  3. E-MA
      ...
      *    NO FICHEIRO.
       ...
       01  LISTA-ALUNOS-SCREEN FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           03  LINE 27 COL 01 PIC X(133) VALUE ALL "_".
           03  LINE 29 COL 53 VALUE "LISTA DE PROCESSOS DE ALUNOS".
           03  LINE 30 COL 01 PIC X(133) VALUE ALL "_".
           03  SHOW LINE LINHA COL COLUNA.
               05  SHOW-IDNUM PIC 9(3) FROM FDIDNUM.
               05  VALUE " | ".
               05  SHOW-NOME PIC X(50) FROM FDNOME.
           03  CONTINUA-LISTA LINE 06 COL 81 PIC 9(3) TO CONS-ALUNO
               AUTO.
      ...
      *    SCREEN DE MENSAGEGM DE ERRO CASO O FICHEIRO ESTEJA VAZIO.
       ...
       01  LISTA-VAZIA-SCREEN FOREGROUND-COLOUR 0 BACKGROUND-COLOR 7.
           ...
           03  LINE 14 COL 01 PIC X(133) VALUE ALL "_".
           03  LINE 17 COL 28 VALUE "NAO EXISTE NENHUM PROCESSO DE ALUNO
      ...
      ******************************************************************
           ...
           MOVE "; GESTOR: ALUNOS" TO WSLOG-PROGRAM
           EXIT SECTION.
      ...
      ******************************************************************
           ...
           PERFORM UNTIL NOVA-ESCOLHA-SCREEN = 2
              ...
              MOVE SPACES TO REG-NOME, REG-EMAIL, REG-MORADA,
                             REG-LOCALIDADE
              MOVE ZEROS  TO REG-IDNUM, REG-TELEF, REG-COD, REG-POST
                             REG-ESTADO

              DISPLAY REGISTAR-SCREEN

              PERFORM REGISTAR-IDNUM
      ...
      ******************************************************************
           ...
           READ ALUNOS RECORD
              INVALID KEY
                 ...
                 MOVE IDNUM TO WSLOG-ADD-KEY
                 MOVE "; REGISTO COM SUCESSO" TO WSLOG-ADD-MESSAGE
                 PERFORM SAVE-LOGRECORDS
                 MOVE WSALUNO TO FDALUNO
                 WRITE FDALUNO
                 END-WRITE
                 DISPLAY LIMPAR-LINES
       ...
       REGISTAR-IDNUM SECTION.
      ******************************************************************
      *    PERGUNTA PARA REGISTO DO NÚMERO DE ALUNO SE DE FORMA MANUAL
      *    OU AUTOMÁTICA.
      ******************************************************************
           PERFORM WITH TEST AFTER UNTIL NOVA-ESCOLHA = 1 OR 2
              MOVE ZEROS TO IDNUM-ESCOLHA-SCREEN, REG-IDNUM
              DISPLAY LIMPAR-LINES
              ACCEPT FORMA-REGISTO-NUMERO
              IF KEYSTATUS = 1003 THEN
                 CLOSE ALUNOS
                 EXIT SECTION
              END-IF
           ...
           IF NOVA-ESCOLHA = 2 THEN
              PERFORM REGISTAR-IDNUM-MANUAL
           ELSE
              PERFORM REGISTAR-IDNUM-AUTO
           EXIT SECTION.

       REGISTAR-IDNUM-MANUAL SECTION.
      ******************************************************************
      *    REGISTO DO NÚMERO DE ALUNO DE FORMA MANUAL.
      ******************************************************************
           PERFORM WITH TEST AFTER UNTIL VERDADEIRO = "S"
           AND REG-IDNUM NOT = "000"
              MOVE SPACES TO VERDADEIRO
              MOVE ZEROS TO  REG-IDNUM
              DISPLAY LIMPAR-LINES
              ...
              MOVE IDNUM TO FDIDNUM

              READ ALUNOS RECORD
                 NOT INVALID KEY
                    DISPLAY LIMPAR-LINES
                    ACCEPT NUMERO-EXISTENTE
                    IF KEYSTATUS = 1003 THEN
                       EXIT SECTION
                    END-IF
                 INVALID KEY
       ...
       REGISTAR-IDNUM-AUTO SECTION.
      ******************************************************************
      *    REGISTO DO NÚMERO DE ALUNO DE FORMA AUTOMÁTICA.
      ******************************************************************
           MOVE 001 TO FDIDNUM
           ...
           PERFORM UNTIL STATUS-IDNUM
              READ ALUNOS NEXT RECORD
                 AT END
                    MOVE FDIDNUM TO IDNUM
                    ADD 1 TO IDNUM
                    SET STATUS-IDNUM TO TRUE
              END-READ
           END-PERFORM
           MOVE IDNUM TO REG-IDNUM
           DISPLAY REG-IDNUM
           MOVE IDNUM TO FDIDNUM
           EXIT SECTION.
      ...
      ******************************************************************
      *    REGISTO DO NOME DO ALUNO PELO UTILIZADOR.
      ******************************************************************
      ...
      ******************************************************************
      *    REGISTO DO TELEFONE DO ALUNO PELO UTILIZADOR.
      ******************************************************************
      ...
      ******************************************************************
      *    REGISTO DO E-MAIL DO ALUNO PELO UTILIZADOR.
      ******************************************************************
      ...
      ******************************************************************
      *    REGISTO DA MORADA DO ALUNO PELO UTILIZADOR.
      ******************************************************************
      ...
      ******************************************************************
      *    REGISTO DO CÓDIGO-POSTAL DO ALUNO PELO UTILIZADOR.
      ******************************************************************
      ...
      ******************************************************************
      *    REGISTO DA LOCALIDADE DO ALUNO PELO UTILIZADOR.
      ******************************************************************
      ...
      ******************************************************************
      *    REGISTO DO ESTADO DO PROCESSO DO ALUNO PELO UTILIZADOR.
      ******************************************************************
      ...
      *    INSTRUÇÃO PARA VERIFICAR SE A LISTA SE ENCONTRA VAZIA
           ...
           PERFORM UNTIL STATUS-IDNUM
              READ ALUNOS NEXT RECORD
                 AT END SET STATUS-IDNUM TO TRUE
                    DISPLAY FIM-LISTA-SCREEN
                    ACCEPT CONTINUA-LISTA
                    IF KEYSTATUS = 1003 THEN
                       EXIT SECTION
                    ELSE
                       IF CONS-ALUNO = 000 THEN
      ...
      ******************************************************************
           ...
           PERFORM UNTIL NOVA-ESCOLHA-SCREEN1 = 2
              ...
              MOVE CONS-ALUNO TO FDIDNUM

              READ ALUNOS RECORD INTO C-ALUNO
                 INVALID KEY
                    ACCEPT REGISTO-INEXISTENTE
                    IF KEYSTATUS = 1003 THEN
                       CLOSE ALUNOS
                 ...
                 NOT INVALID KEY
                    ...
                    MOVE CONS-ALUNO TO WSLOG-VIEW-KEY
                    MOVE "; CONSULTA COM SUCESSO" TO WSLOG-VIEW-MESSAGE
                    PERFORM SAVE-LOGRECORDS
                    DISPLAY CONS-DADOS-SCREEN
                    EVALUATE FDESTADO
                       WHEN 1 DISPLAY INSCRITO-DISPLAY
                       WHEN 2 DISPLAY PRESENTE-DISPLAY
                       WHEN 3 DISPLAY SUSPENSO-DISPLAY
                       WHEN 4 DISPLAY CESSADO-DISPLAY
                       WHEN 5 DISPLAY CONCLUIDO-DISPLAY
                       WHEN 6 DISPLAY DOENTE-DISPLAY
                       WHEN 7 DISPLAY OUTRO-DISPLAY
                    END-EVALUATE
              END-READ
      ...
      *    MESMA OS DADOS E MENSAGEM DE ALERTA.
              ...
              READ ALUNOS RECORD WITH LOCK
              END-READ
              COMMIT
              IF FS-ALUNOS = "51" THEN
      ...
      ******************************************************************
           ...
           PERFORM UNTIL NOVA-ESCOLHA-SCREEN3 = 2
              ...
              READ ALUNOS RECORD INTO C-ALUNO WITH LOCK
                 INVALID KEY
                    ACCEPT REGISTO-INEXISTENTE
                    IF KEYSTATUS = 1003 THEN
                       CLOSE ALUNOS
      ...
      ******************************************************************
           PERFORM WITH TEST AFTER UNTIL NOVA-ESCOLHA = 1 OR 2
              ...
              IF KEYSTATUS = 1003 THEN
                 ...
                 MOVE CONS-ALUNO TO WSLOG-DELETE-KEY
           ...
           PERFORM UNTIL NOVA-ESCOLHA-SCREEN4 = 2
              ...
              PERFORM WITH TEST AFTER UNTIL VALID-ALTERAR
                 ...
                 IF KEYSTATUS = 1003 THEN
                    ...
                    MOVE CONS-ALUNO TO WSLOG-EDIT-KEY
